...
function handleOptionDelete(id: string | undefined, setOpen: { (value: SetStateAction<boolean>): void; (arg0: boolean): void; }, handleUpdate: () => void) {
  ...
  axios.delete(`${import.meta.env.VITE_url_backend}/produtos/${id}/?id_token=${localStorage.getItem('authToken')}`, {
    headers: {
...
export default function ModalDeleteProduto({ title, id, handleUpdate }: ModalProps) {
