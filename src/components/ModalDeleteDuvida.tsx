...
export default function ModalDeleteDuvida({ title, id, handleUpdate }: ModalProps) {
    ...
    return (
        <>
            <button
                onClick={handleShow}
                className="bg-red-600 hover:bg-red-700 text-white px-5 py-2 rounded-md shadow-md font-semibold transition duration-300 flex items-center justify-center gap-2 min-w-[120px]"
            >
                Deletar
            </button>
